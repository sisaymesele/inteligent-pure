    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizational_classification', models.CharField(choices=[('profitable', 'Profitable'), ('non_profitable', 'Non-Profitable')], default='profitable', max_length=20, verbose_name='Organization Classification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Owner'), ('viewer', 'Viewer'), ('editor', 'Editor'), ('viewer', 'Viewer')], default='viewer', max_length=20)),
