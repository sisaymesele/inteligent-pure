    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_classification', models.CharField(choices=[('profitable', 'Profitable'), ('non_profitable', 'Non-Profitable')], default='profitable', max_length=20, verbose_name='Organization Classification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('organization_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='management_project.organizationalprofile')),
                ('strategic_report_period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management_project.strategiccycle')),
            ],
            options={
                'ordering': ['swot_type', 'priority', '-created_at'],
            },
