...
@login_required
@role_required(['viewer', 'editor', 'owner', 'admin'], model_name='stakeholder', action='view')
...
@login_required
@role_required(['editor', 'owner', 'admin'], model_name='stakeholder', action='create')
...
@login_required
@role_required(['editor', 'owner', 'admin'], model_name='stakeholder', action='edit')
...
@login_required
@role_required(['owner', 'admin'], model_name='stakeholder', action='delete')
def delete_stakeholder(request, pk):
    ...
    return render(request, 'stakeholder_list/delete_confirm.html', {
...
def export_stakeholders_to_excel(request):
    ...
    stakeholders = Stakeholder.objects.filter(organization_name=request.user.organization_name)
